...
{
	return compare(((const frame_desc*)pd1_p)->map.page_id, ((const frame_desc*)pd2_p)->map.page_id);
}
...
{
	return compare(((const frame_desc*)pd1_p)->map.frame, ((const frame_desc*)pd2_p)->map.frame);
}